<?php 
  ...
  $data = query("SELECT * FROM review,users WHERE review.id=users.id and email='$email'");
?>
...
<head>
    ...
    <title>Tabel Kritik & Saran</title>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Tabel Kritik & Saran</a>
                    </li>
                    <li class="nav-item">
    ...
    <br>
    <h1 class="text-center mt-5">Tabel Kritik & Saran</h1>
    ...
    <div class="container mb-5 table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <?php $_SESSION['kritik']=$value['kritik'] ?>
                <tr>
                    <th scope="row"><?= $i; ?></th>
                    <td><?= $value["kritik"]; ?></td>
                    <td><?= $value["saran"]; ?></td>
                    <td>
                        <a class="btn btn-warning" href="edit.php?id=<?= $value["kritik"]; ?>" role="button">Edit</a> |
                        <a class="btn btn-danger" onclick="return confirm('apakah anda yakin?')"
                            href="hapus.php?id=<?= $value["kritik"]; ?>" role="button">Hapus</a>
                    </td>
                </tr>
                <?php $i++ ?>
                <?php endforeach ?>
