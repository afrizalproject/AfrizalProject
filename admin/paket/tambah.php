                ...
                <div class="col-md-6">
                    <form action="" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="namapaket" aria-describedby="namapaket" name="namapaket" required>
                        </div>
                        <div class="mb-3">
                            <label for="hargapaket" class="form-label">Harga Paket</label>
                            <input type="number" class="form-control" id="hargapaket" aria-describedby="hargapaket" name="hargapaket" required>
                        </div>
