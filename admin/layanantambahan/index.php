<?php 
  ...
  $data = query("SELECT * FROM layanantambahan");
?>
...
<head>
    ...
    <title>Tabel Layanan Tambahan</title>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Tabel Layanan Tambahan</a>
                    </li>
                    <li class="nav-item">
    ...
    <br>
    <h1 class="text-center mt-5">Tabel Layanan Tambahan</h1>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="edit.php?id=<?= $value["id_layanantambahan"]; ?>"
                            role="button">Edit</a> |
                        <a class="btn btn-danger" onclick="return confirm('apakah anda yakin?')"
                            href="hapus.php?id=<?= $value["id_layanantambahan"]; ?>" role="button">Hapus</a>
                    </td>
                </tr>
                <?php $i++ ?>
                <?php endforeach ?>
