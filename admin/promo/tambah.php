            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form action="" method="POST">
                        <div class="mb-3">
                            <label for="durasiacara" class="form-label">Promo</label>
                            <input type="text" class="form-control" id="durasiacara" aria-describedby="namaLayanan" name="namaPromo" required>
                        </div>
